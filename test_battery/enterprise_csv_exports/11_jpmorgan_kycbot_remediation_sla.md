...
**Reference ID:** `KZD-20260504-8D4D81`
**Date issued:** 2026-05-04
**Customer:** Acme Corp (customer)
**Vendor:** JPMorgan
**Trace fingerprint:** `8d4d812fbeafd267`
...
`family=linear_residual`, source: *JPMorgan KYC documentation v3.2*) and the
...
This SLA is bound to the trace fingerprint `8d4d812fbeafd267` and the agreement
