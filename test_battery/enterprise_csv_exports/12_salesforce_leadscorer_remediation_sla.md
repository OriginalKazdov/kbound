...
**Reference ID:** `KZD-20260504-A37F49`
**Date issued:** 2026-05-04
**Customer:** Acme Corp (customer)
**Vendor:** Salesforce
**Trace fingerprint:** `a37f49936737c7b1`

## Finding

The behavioral-specification compliance audit performed on the trace
sample referenced above measured a **87.5%**
agreement rate between the vendor's stated specification (
`family=polynomial_threshold`, source: *Einstein scoring rules v4.1*) and the
...
This SLA is bound to the trace fingerprint `a37f49936737c7b1` and the agreement
