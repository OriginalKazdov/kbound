...
**Reference ID:** `KZD-20260504-52B2D8`
**Date issued:** 2026-05-04
**Customer:** Acme Corp (customer)
**Vendor:** Capital One
**Trace fingerprint:** `52b2d8053f924ae4`

## Finding

The behavioral-specification compliance audit performed on the trace
sample referenced above measured a **72.5%**
agreement rate between the vendor's stated specification (
`family=linear_residual`, source: *vendor system prompt v7.0*) and the
...
This SLA is bound to the trace fingerprint `52b2d8053f924ae4` and the agreement
